...
// PURPOSE: MINIMAL NAVBAR WITH ABOUT COMPANY (MODAL) + CLASS REDIRECT + SEO
// VERSION: 2025.7
...
export default function Promotion() {
  ...
  return (
    <>
      {/* ===================== HELMET FOR SEO ===================== */}
      <Helmet>
        <title>Openroot | Technology & Education Platform</title>
        <meta
          name="description"
          content="Openroot empowers students and MSMEs with software solutions and expert-led courses in prompt engineering and investing."
        />
        <meta
          name="keywords"
          content="Openroot, Openroot Classes, software solutions, MSME software, investing education, prompt engineering"
        />
      </Helmet>
            ...
            >
              ...
              >
                ...
                <div className="about-company-promo">
                  <p>
                    <strong>At Openroot</strong>, we believe in building
                    technology that truly empowers people.
                  </p>
